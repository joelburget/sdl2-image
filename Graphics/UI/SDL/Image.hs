...
isBMP path = RW.withFile path "rb" $
             isBMPRW
...
isPNM path = RW.withFile path "rb" $
             isPNMRW
...
isXPM path = RW.withFile path "rb" $
             isXPMRW
...
isXCF path = RW.withFile path "rb" $
             isXCFRW
...
isPCX path = RW.withFile path "rb" $
             isPCXRW
...
isGIF path = RW.withFile path "rb" $
             isGIFRW
...
isJPG path = RW.withFile path "rb" $
             isJPGRW
...
isTIF path = RW.withFile path "rb" $
             isTIFRW
...
isPNG path = RW.withFile path "rb" $
             isPNGRW
...
isLBM path = RW.withFile path "rb" $
             isLBMRW
